 ...
 _________________________________________________________ -->
      <!-- Memakai bahasa Php murni-->
                        ...
                        <?php  
                                ...
                                $select_ukuran= "SELECT uk.ukuran,pr.kode_ukuran,uk.gambar_ukuran FROM ukuran uk,barang ba,pricelist pr where ba.kode_barang=pr.kode_barang and pr.kode_ukuran=uk.kode_ukuran and ba.kode_barang='".$kodebarang."' group by uk.kode_ukuran";
            ...
            <div id="advantages">
				...
				<div class="box">
					<form method="post" action="<?php echo base_url('Php/stiker/'.$kode);  ?>">
						<h1>Choose Your Size & Quantity</h1>
						<ul class="nav nav-pills nav-justified">
							<li class="disabled"><a href="#"><b>1</b><br>Choose Your Paper</a>
							</li>
							<li class="disabled"><a href="#"><b>2</b><br>Choose Your Lamination</a>
							</li>
							<li class="active"><a href="#"><b>3</b><br>Set the Size & Quantity</a>
							</li>
					...
					<div class="content">
							...
							<div class="same-height-row">
								<div class="col-sm-4">
									<div class="box same-height clickable">
										<h3><a href="#">SIZE</a></h3>
										  <button aria-expanded="true" data-toggle="dropdown" class="btn btn-primary btn-lg dropdown-toggle" type="button">Choose Size&nbsp;&nbsp;&nbsp;<b class="caret"></b></button>
                                            <ul class="dropdown-menu" style="overflow:auto;height:220px;">
                                                 <?php while ($row2 = mysqli_fetch_array($query_ukuran)) {?> 
                                                <li style="width:300px;"><a href="<?php echo base_url('Php/customsize/'.$row2['ukuran']."/".$kode);  ?>"><img class="img-thumbnail hidden-xs" style="height:90px;" src='<?php echo 'http://localhost/tcreative/assets/admin_data/Ukuran/'.$row2['gambar_ukuran']?>'>&nbsp;&nbsp;<?php echo $row2['ukuran']?></a></li>
                                                <?php }?>
								...
								<div class="col-sm-4">
									<div class="box same-height clickable">
										...
										<div class="dropdown" style="background-color:#e64b09;">
                                          <button class="dropbtn">Choose Quantity</button>
                                          <div class="dropdown-content">
                                          <a href="<?php echo base_url('Php/customqty/10/'.$kode);  ?>">10</a>
                                          <a href="<?php echo base_url('Php/customqty/25/'.$kode);  ?>">25</a>
                                          <a href="<?php echo base_url('Php/customqty/50/'.$kode);  ?>">50</a>
                                          <a href="<?php echo base_url('Php/customqty/100/'.$kode);  ?>">100</a>
                                          </div>
                                        </div>
									</div>
								</div>
						...
						<div class="box-footer">
							<div class="pull-left" style='margin-right:70%;'>
								<a href="<?php echo base_url('Php/laminasi/'.$kode);  ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back</a>
							</div>
