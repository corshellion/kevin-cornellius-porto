        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="<?php echo base_url('Php/checkout5');?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="payment" value="VISA and Mastercard">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url('Php/checkout3');?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Delivery Method</a>
                                </div>
