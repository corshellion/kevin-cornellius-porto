                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>#<?php echo $key1->kode_pesanan; ?></th>
                                        <td><?php echo $key1->tanggal_pesanan; ?></td>
                                        <td>Rp. <?php echo $key1->total; ?></td>
                                        <td><span class="label label-info"><?php echo $key1->status; ?></span>
                                        </td>
                                        <td><a href="<?php echo base_url('Php/order/'.$key1->kode_pesanan);?>" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>
                                     <?php } ?>
                                     <?php endforeach; ?>
                                   ...
                                   <!-- <tr>
                                        ...
                                        <td><a href="<?php echo base_url('Php/order');?>" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th># 1735</th>
