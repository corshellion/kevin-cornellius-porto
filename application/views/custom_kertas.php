...
<?php  $email = $this->session->userdata('username_login');?>
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url('Php/index_login');?>" method="post">
 ...
 _________________________________________________________ -->
            ...
            <div id="advantages">
				...
				<div class="box">
					<form method="post" action="<?php echo base_url('Php/laminasi')?>">
						<h1>Choose Your Paper</h1>
						<ul class="nav nav-pills nav-justified">
							<li class="active"><a href="#"><b>1</b><br>Choose Your Paper</a>
							</li>
                        ...
                        <?php  $data=$this->cart->contents(); ?>
                                        <?php foreach($data as $items){  ?>
                                             <?php if($items['id']==$kode){ ?>
                                                <?php $kode=$items['rowid']?>
                                                <?php $id=$items['id']?>
                                            <?php }?>
                                         <?php } ?>
					<div class="content">
							...
							<div class="same-height-row">
								<div class="col-sm-4">
									<div class="box same-height clickable">
										<h3><a href="<?php echo base_url('Php/customkertas/bontax/'.$kode);?>">BONTAX </a></h3>
										<p>Kertas stiker ini bertekstur seperti kertas art paper dan daya rekatnya tinggi. Biasanya digunakan untuk produk atau kemasan.</p>
									</div>
								</div>

								<div class="col-sm-4">
									<div class="box same-height clickable">
										<h3><a href="<?php echo base_url('Php/customkertas/vynil/'.$kode);?>">VYNIL</a></h3>
										<p>Kertas stiker ini bertekstur plastik, sehingga tahan air dan tahan panas. Permukaan kertas sendiri sudah glossy tanpa dilaminasi.</p>
									</div>
								</div>

								<div class="col-sm-4">
									<div class="box same-height clickable">
										<h3><a href="<?php echo base_url('Php/customkertas/transparent/'.$kode);?>">TRANSPARENT</a></h3>
										<p>Kertas stiker ini sifatnya sama persis dengan stiker vinyl, hanya saja transparan.</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="box-footer">
							<div class="pull-left" style="margin-right:70%;">
								<a href="<?php echo base_url('Php/detail/'.$id);?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back</a>
							</div>
