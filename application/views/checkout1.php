        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="<?php echo base_url('Php/checkout2');?>">
                            <h1>Checkout</h1>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url('Php/basket');?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to basket</a>
                                </div>
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary">Continue to Address<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
