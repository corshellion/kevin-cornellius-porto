            ...
            <div class="container">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form method="post" action="<?php echo base_url('Php/checkout1/');?>">

                            <h1>Shopping Cart</h1>
                            <p class="text-muted">You currently have <?php echo $keranjang;?> item(s) in your cart.</p>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#">
                                                    <img src="<?php echo base_url('assets/admin_data/galery/'.$items['image']);?>" alt="Label Nama">
                                                </a>
                                            </td>
                                            <td><a href="<?php echo base_url('Php/detail/'.$items['id']);?>"><?php echo $items['name']?></a>
                                            </td>
											<td>
												Paper<br>
												Lamination<br>
											...
											<td>
												: <?php echo " ".$items['paper']?><br>
												:<?php echo " ".$items['lamination']?><br>
												: <?php echo " ".$items['size']?><br>
                                                : <?php echo " ".$items['input1']?><br>
                                                : <?php echo " ".$items['input2']?><br>
                                                : <?php echo " ".$items['delivery']?><br>
                                                : <?php echo " ".$items['payment']?>
											</td>
                                            <td>
                                                <input type="number" value="<?php echo $items['qty']?>" class="form-control" style="width:70px;" disabled>
                                            </td>
                                            <td><?php echo " Rp.".$items['price']?></td>
                                            <td>Rp.0.00</td>
                                            <td><?php echo " Rp.".$items['price']?></td>
                                            <?php  $rowid= $items['rowid']; ?>
                                            <td><a href="<?php echo base_url('Php/deletebasket/'.$rowid); ?>"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        <tr>
											...
											<th></th>
											<th></th>
                                            <th colspan="2">Rp.<?php echo $total_belanja;?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url('Php/product');?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                                </div>
                                <div class="pull-right">
                                    <button class="btn btn-default"><a href="<?php echo base_url('Php/updatebasket') ?>"><i class="fa fa-refresh"></i> Update basket</a></button>
