...
<?php 
    ...
    $select_pricelist = "SELECT * FROM pricelist";
    ...
    $query_pricelist= mysqli_query($conn, $select_pricelist);
	...
	while ($row = mysqli_fetch_array($query_pricelist))
	{
		echo "<tr>
				<td><center>".$row['kode_pricelist']."</td>
