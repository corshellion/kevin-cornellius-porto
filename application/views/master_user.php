...
<?php 
	...
	while ($row = mysqli_fetch_array($query_user))
	{
		echo "<tr>
				...
				<td><center>".$row['pass_user']."</td>
				<td><center>".$row['alamat_user']."</td>
				<td><center>".$row['telp_user']."</td>
			</tr>";
	}
	echo "	</tbody>
		</table><br>";
	...
	echo "<form action="."master_user"." method="."post".">";
	
	echo "<br>Nama		: ";
	echo "<input type="."text"." name="."nama_user"." style="."width:170px".">";
		
	echo "<br>Email		: ";
	echo "<input type="."text"." name="."email_user"." style="."width:170px".">";
	
	echo "<br>Password	: ";
	echo "<input type="."text"." name="."pass_user"." style="."width:170px".">";
	
	echo "<br>Alamat		: ";
	echo "<textarea name="."alamat_user"." style="."width:170px".">Enter text here...</textarea>";
	
	echo "<br>Telepon		: ";
	echo "<input type="."text"." name="."telp_user"." style="."width:170px".">";
...
//----------INSERT----------
	...
	if(isset($_POST["insert"])){
		...
		$insert_user = "INSERT INTO user VALUES ('$nama_user','$email_user','$pass_user','$alamat_user','$telp_user')";
		
		$query_insert  = mysqli_query($conn, $insert_user);
		if (!$query_insert) {
			die ('SQL Error: ' . mysqli_error($conn));
		}
		header("location:http://localhost/tcreative/Php/master_user");
	}
	mysqli_close($conn);
//--------------------------
...
//----------UPDATE----------
	...
	if(isset($_POST["update"])){
		...
		$update_user = "UPDATE user SET nama_user='$nama_user',email_user='$email_user',pass_user='$pass_user',alamat_user='$alamat_user',telp_user='$telp_user' where email_user='$email_user'";
...
//----------DELETE----------
	...
	if(isset($_POST["delete"])){
		...
		$delete_user="DELETE from user where email_user='$email_user'";
		
		$query_delete  = mysqli_query($conn, $delete_user);
		if (!$query_delete) {
			die ('SQL Error: ' . mysqli_error($conn));
		}
		header("location:http://localhost/tcreative/Php/master_user");
