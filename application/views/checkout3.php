        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="<?php echo base_url('Php/checkout4/');?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box shipping-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="delivery" value="Grab Ex">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="box shipping-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="delivery" value="Go Send">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url('Php/checkout2');?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Address</a>
                                </div>
