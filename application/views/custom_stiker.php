...
<head>
    ...
    <link href="<?php echo base_url('assets/css/radiobutton.css');?>" rel="stylesheet">
...
<?php  $email = $this->session->userdata('username_login');?>
 ...
 _________________________________________________________ -->
            ...
            <div id="advantages">
				<div class="box">
					<form method="post" action="<?php echo base_url('Php/upload/'.$kode);  ?>" enctype="multipart/form-data" >
						<h1>Customize Sticker</h1>
						<ul class="nav nav-pills nav-justified">
							...
							<li class="active"><a href="#"><b>4</b><br>Customize Your Own Sticker</a>
							</li>
					...
					<div class="content" >
							...
							<div class="same-height-row">
								<div class="col-sm-4" >
									<div class="box same-height clickable" >
										...
										<form action="<?php echo base_url('Php/upload/'.$kode);  ?>" method="post" enctype="multipart/form-data">
								...
								<div class="col-sm-4" >
									<div class="box same-height clickable">
                                        <h3><a href="#">Picture Position</a></h3>
								...
								<div class="col-sm-4">
									<div class="box same-height clickable">
                                        <h3><a href="#">Text Input</a></h3>
                                                ...
                                                Text input 1: <input type="text" name="name1"><br>
                                                Text input 2: <input type="text" name="name2"><br>
                                               <!-- <input type="submit">-->
						...
						<div class="box-footer">
							<div class="pull-left" style='margin-right:70%;'>
								<a href="<?php echo base_url('Php/size/'.$kode);  ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back</a>
							</div>
